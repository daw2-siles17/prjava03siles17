...
public class Prjava03siles17 extends Frame 
   ...
   public Prjava03siles17 () { 
      ...
      setTitle("nova finestra prjava03siles17");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava03siles17();  // Let the construct do the job 
   } 
